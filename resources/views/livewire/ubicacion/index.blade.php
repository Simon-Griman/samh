                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="ubicacion" class="col-form-label">Nombre de la Ubicacion:</label>
                                        <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" id="ubicacion" wire:model.defer="ubicacion" name="ubicacion" require value="{{ old('ubicacion') }}">
