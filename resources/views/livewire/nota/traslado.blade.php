<div class="container">
    <div class="row d-flex justify-content-center">
        <h2 class="col-lg-12 text-center">Traslado de Equipos</h2>
        <div class="card col col-lg-6 mx-auto">
            <div class="card-body">
                <form wire:submit.prevent="enviar" class="mb-0 pl-0">
                    ...
                    <div class="">
                        <h5>Origen</h5>
                        <input type="text" class="form-control" wire:model="origen">
                        @error('origen') <span class="error text-red">{{ $message }}</span> @enderror
                    </div>

                    <div class="mt-4 mb-4">
                        <h5>Destino</h5>
                        <input type="text" class="form-control" wire:model="destino">
                        @error('destino') <span class="error text-red">{{ $message }}</span> @enderror
                    </div>
