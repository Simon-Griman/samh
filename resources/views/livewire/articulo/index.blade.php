        ...
        <div class="card mt-2" style="max-height: 80vh;">
            <div class="card-header" style="background-color: #eee;">
                <div class="text-center">
                    <a wire:click="modalCrear()" class="btn btn-primary" data-toggle="modal" data-target="#crear">Nuevo Articulo</a>
                </div>
            </div>
                ...
                <table class="table table-responsive table-hover">
                    ...
                    @foreach($articulos as $articulo)
                        <tr>
                            ...
                            <td>
                                <a wire:click="modalEditar({{ $articulo->id }})" class="btn btn-success" data-toggle="modal" data-target="#crear">Editar</a>

                                @can('Super-User')
                                <a wire:click="confirBorrar({{ $articulo->id }})" class="btn btn-danger" data-toggle="modal" data-target="#borrar">Borrar</a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>¿Realmente desea borrar <b>{{ $articulo_borrar }}</b> de la lista?</h5>
                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="articulo" class="col-form-label">Nombre del Articulo:</label>
                                        <input type="text" class="form-control @error('articulo') is-invalid @enderror" id="articulo" wire:model.defer="articulo" name="articulo" require value="{{ old('articulo') }}" autofocus>
