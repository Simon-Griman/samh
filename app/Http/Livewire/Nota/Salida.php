...
class Salida extends Component
{
    ...
    public function enviar()
    {
        ...
        return redirect()->route('salida.pdf', ['selecciones' => json_encode($this->selecciones), 'user_id' => $this->usuario, 'observacion' => $this->observacion]);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.nota.salida', compact('users', 'bienes', 'num1', 'num2', 'match'));
    }
}
