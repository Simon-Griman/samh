...
{
    public $usuario = '', $equipos_user, $observacion = '', $origen, $destino;
    ...
    public function enviar()
    {
        ...
        return redirect()->route('traslado.pdf', ['selecciones' => json_encode($this->selecciones), 'user_id' => $this->usuario, 'observacion' => $this->observacion, 'origen' => $this->origen, 'destino' => $this->destino]);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.nota.traslado', compact('users', 'bienes', 'num1', 'num2', 'match'));
    }
}
