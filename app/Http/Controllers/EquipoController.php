...
class EquipoController extends Controller
{
    ...
    {
        $this->equipos = Equipo::select('equipos.id', 'tipoequipos.id as id_tipo', 'tipoequipos.nombre as equipo', 'marcas.id as id_marca', 'marcas.nombre as marca', 'modelos.id as id_modelo', 'modelos.nombre as modelo', 'serial', 'bien_nacional', 'bien_pdvsa', 'bien_menpet', 'rolequipos.id as id_rol', 'rol', 'departamentos.id as id_departamento', 'departamentos.nombre as departamento', 'users.id as id_user', 'name', 'observacion', 'creado', 'actualizado', 'ubicacions.nombre as ubicacion', 'equipos.created_at as f_creado', 'equipos.updated_at as f_actualizado', 'fecha_adquisicion', 'depreciacion', 'proveedors.id as id_proveedor')
